            ...
            <h1 class="h">Returns Info Form</h1>
                ...
                <div>
                    ...
                    <table class="table" id="datatable">
                        <tr>
                            <td><input type="text" list="id" name="ItemName" id="ItemName" class="input" required>
                            <datalist id="id">
                            <?php
                            ...
                            <td class="column"><input type="text" name="Amount" id="Amount" class="input" onclick="amount()" required></td>
                        </tr>
                ...
                <div>
                    <table class="table"> 
                        <tr>
                            ...
                            <td><input type="text" name="TotalAmount" id="TotalAmount" class="inputamount" required></td>
                        </tr>
                    </table>
                </div>
                <div>
                    <table class="table"> 
                        <tr>
                            ...
                            <td><input type="text" name="DuesAmount" id="DuesAmount" class="inputamount" onclick="substract()" required></td>
                        </tr>
                    </table>
                </div>
                <div>
