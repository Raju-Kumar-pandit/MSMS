    ...
    VALUES('$PurchaseId','$Date','$SupplierId','$Mode','$TotalAmount','$PayAmount','$DuesAmount')";
      if($con->query($sql)===TRUE){
        foreach($ItemName as $key =>$value){
            ...
            VALUES('$PurchaseId','$ItemName[$key]','$BatchNo[$key]','$Quantity[$key]','$Rate[$key]','$Amount[$key]','$Discount[$key]','$ActualAmt[$key]','$SGSTRate[$key]','$SGSTAmount[$key]','$CGSTRate[$key]','$CGSTAmount[$key]','$Expiry[$key]')";
